      ...
      <header className="mb-6 w-full text-center">
        ...
        {path.length > 0 && (
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
            <p className="inline-flex items-center gap-2 rounded-full bg-surface px-4 py-1.5 text-sm font-semibold text-ink shadow-clay-soft">
              <span
            ...
            <p className="inline-flex items-center gap-2 rounded-full bg-surface/80 px-3 py-1.5 text-xs font-medium text-muted shadow-clay-soft">
